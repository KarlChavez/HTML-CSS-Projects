    ...
    public static void main(String[] args) {
        ...
        if (choice.equals("y")) {
            while (choice.equals("y")) {
                ...
                //if the user inputs a negative answer, that'll be an
                //indication that it's time to quit and break the while loop
                if (number < 0) {
                    out.print("You've entered a negative value. Goodbye!");
                    choice = "n";
                }

                //when the answer isn't negative
                else {
                    ...
                    if (result == 0) {
                        out.println(
                                "You've entered the value 0 which can't be com"
                                        + "puted.");
                    }

                    else {
                        //printing out the result
                        out.println("The square root value of " + number
                                + " is: " + result + "\n");
                    }
                }

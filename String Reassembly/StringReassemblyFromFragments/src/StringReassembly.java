...
public final class StringReassembly {
    ...
    public static String combination(String str1, String str2, int overlap) {
        ...
        //Removes the beginning of str2 that overlaps
        String sub2 = str2.substring(overlap);
    ...
    public static void addToSetAvoidingSubstrings(Set<String> strSet,
        ...
        /*
         * The boolean isIn checks if the string is inside the set. The boolean
         * is true if it is and false otherwise
         */
        boolean isIn = false;
        for (String s : strSet) {
            if (s.contains(str)) {
        ...
        /*
         * If the boolean isIn isn't true, then we check through each of the
         * strings again in the strSet to check if they are a substring of str.
         * Any substrings of str is removed.
         */
    ...
    public static Set<String> linesFromInput(SimpleReader input) {
        ...
        //Stores the set of all individual lines read from input
        Set<String> lineSet = new Set1L<>();

        /*
         * Goes through each line and adds them into the set only if it's not
         * already in the set and there is not a substring of another
         */
        while (!input.atEOS()) {
            String line = input.nextLine();
            if (!lineSet.contains(line)) {
                //checks whether there is not a substring of another
                addToSetAvoidingSubstrings(lineSet, line);
            }
        }
    ...
    public static void printWithLineSeparators(String text, SimpleWriter out) {
        ...
        //replaces each "~" with a line separator or "\n";
